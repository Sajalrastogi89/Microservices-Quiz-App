...
<div style="display: flex; justify-content: space-around;">
  <img src="/img/Architecture.jpg" alt="Architecture 1" style="width: 45%; margin-right: 20px;">
  <img src="/img/Eureka Server-Client.jpg" alt="Architecture 2" style="width: 45%; margin-left: 20px;">
  <img src="/img/LoadBalancer.png" alt="Architecture 3" style="width: 45%; margin-right: 20px;">
  <img src="/img/PostMan.png" alt="Architecture 4" style="width: 45%; margin-left: 20px;">
</div>
